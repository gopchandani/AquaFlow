...
def main():
    ...
    pktA = Ether(dst='00:00:00:00:05:02', type=0x1234) / CodingPacket(count=0, packet_contents="A", packet_payload="A" * 100)
    pktA = pktA/' '

    pktB = Ether(dst='00:00:00:00:05:02', type=0x1234) / CodingPacket(count=0, packet_contents="B", packet_payload="B" * 100)
    pktB = pktB/' '
